...
Используйте команду ' man '  для  получения справочной информации  о различных командах системы ( 'man date' , 'man who' , ' man tty ' и т.д.  ).
...
\- команда  перечисляет имена существующих в вашем каталоге файлов.
